...
public class IdleState:State
{
    ...
    public override void Enter()
    {
		...
		myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 0, 40));
		myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 10, 40));
		myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 15, 30));
		myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 10, 20));
		myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 5, 20));
		myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 0, 30));
		myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 0, 80));
        //myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 0, -10));
        myGameObject.GetComponent<SteeringBehaviours>().path.Looped = false;            
